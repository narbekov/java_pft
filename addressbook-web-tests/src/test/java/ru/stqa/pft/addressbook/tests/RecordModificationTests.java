...
public class RecordModificationTests extends TestBase {
    ...
    public void testRecordModification()
    {
        ...
        app.getRecordHelper().fillInfoForm(new RecordData("Vasiliy", "Vasya", "Pupkin", "pupkin", "junior QA", "KartinaCanada", "Nab.Sev.Dviny 30", "88003535", "qwerty@mail.com",null),true);
