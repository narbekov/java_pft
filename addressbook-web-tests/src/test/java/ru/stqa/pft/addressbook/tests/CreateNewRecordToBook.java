...
public class CreateNewRecordToBook extends TestBase{
  ...
  public void testCreateNewRecordToBook() throws Exception {
    ...
    app.getRecordHelper().fillInfoForm(new RecordData("Vyacheslav", "Slava", "Narbekov", "spirit29", "QA", "VMedia", "Loginova 80-1", "+79210780445", "narbeckov.slava@yandex.ru", "test1"),true);
